<?php
  ...
  $itm_id = $_GET['item_id'];
  $sql = " SELECT * FROM items where item_id = '$itm_id' ";
...
<!DOCTYPE html>
    <head>
        ...
        <title>The SARUS | <?php echo $singleRow['1']; ?> </title>

        <link rel="stylesheet" href="css/common.css">
        <link rel="stylesheet" href="css/header.css">
        <link rel="stylesheet" href="css/cart.css">
        <link rel="stylesheet" href="css/hamburger.css">
        <link rel="stylesheet" href="css/opened_box.css">
      ...
      <div class="container"> 
        ...
        <!--opened image-->
          <div class="slideshow-container1">
            ...
            <div class="mySlides">
              <img src="<?php echo $singleRow['9']; ?>"  alt="product image 1">
            </div>
    
            <div class="mySlides">
              <img src="<?php echo $singleRow['10']; ?>" alt="product image 2">
            </div>
    
            <div class="mySlides">
              <img src="<?php echo $singleRow['11']; ?>" alt="product image 3">
            </div>
            ...
            <div style="text-align: center" class="imgbelow">
              <div class="dot" onclick="currentSlides(1)"> <img src="<?php echo $singleRow['9']; ?>"  alt="hello" width="50px" height="50px"> </div>
              <div class="dot" onclick="currentSlides(2)"> <img src="<?php echo $singleRow['10']; ?>" alt="hello" width="50px" height="50px"> </div>
              <div class="dot" onclick="currentSlides(3)"> <img src="<?php echo $singleRow['11']; ?>" alt="hello" width="50px" height="50px"> </div>
            </div>
        ...
        <!--product description-->
          <div class="slideshow-container2">
            ...
            <div class="gry-clr">
              ...
              <h1 id="hd-clr"><?php echo $singleRow['1']; ?></h1>
              <h3>MRP: &#8377;<?php echo $singleRow['3']; ?>  &#160;&#160;&#160; <s>&#8377;<?php echo $singleRow['2']; ?></s> <?php echo $singleRow['4']; ?>%off</h3>
              <h8>Delivery will be charged</h8>
  
              <ul>
                <li><p><b>Occasion</b>	&nbsp&nbsp <?php echo $singleRow['5']; ?></p></li>
                <li><p><b>Brand</b>	    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <?php echo $singleRow['6']; ?></p></li>
                <li><p><b>Colour</b>	&nbsp&nbsp&nbsp&nbsp&nbsp <?php echo $singleRow['7']; ?></p></li>
                <li><p><b>Size</b>	    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <?php echo $singleRow['8']; ?></p></li>
                <h3>About this item</h3>
                <li><p><?php echo $singleRow['12']; ?></p></li>
                <li><p><?php echo $singleRow['13']; ?></p></li>
                <li><p><?php echo $singleRow['14']; ?></p></li>
                <li><p><?php echo $singleRow['15']; ?></p></li>
              </ul>
           ...
           <div class="productoption">
            ...
            <?php
              $cart1 = isset($_COOKIE["cart"])  ? $_COOKIE["cart"] : "[]" ;
              $cart2 = json_decode($cart1, true);
              $a = 0;
              $name = $singleRow['1'];
              if($cart2 != NULL){
                for($i=0 ; $i< count($cart2) ; $i++){
                  if($cart2[$i]["item_name"] == $name){
                    $a = $a + 1;
                  }
                }  
              }
            ...
            ?>
              ...
              <div class="productoption1">
                <div class="order">
                  <input type="submit" value="Added !" class="inphov">
                </div>
              </div>
            ...
            ?>
              ...
              <div class="productoption1">
                <form action="add_product_to_cart.php" method="post">
                  <input type="hidden" name="item_id" value="<?php echo $itm_id; ?>">
                  <div class="addToCart">
                    ...
                    <input type="submit" value="Add to cart" class="inphov">
                  </div>
                </form>
              </div>
            <?php 
        ...
        <div class="foot1">
          <center>
            ...
            <div class ="foot2">
              ...
              <a href="#"> <img src="img\social-media-logo\twitter.png"   alt="twitter"    style="width:23px;height:23px;"> </a>
